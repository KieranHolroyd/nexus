...
import { Server, Search, LogIn, LogOut, LayoutGrid, List as ListIcon, User, Settings } from "lucide-react";
                    ...
                    {user ? (
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button variant="ghost" className="relative h-10 w-10 rounded-full bg-muted/50 p-0 hover:bg-muted transition-colors">
