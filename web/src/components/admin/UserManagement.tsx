...
export function UserManagement({ users, loading, onRefresh }: UserManagementProps) {
    ...
    const handleDeleteUser = async (id: string) => {
        if (!confirm("Delete this user? All their credentials will be removed.")) return;
    ...
    if (users.length === 0) {
        return (
            <div className="text-center py-20 border rounded-xl bg-card/50 border-dashed">
                ...
                <p className="text-muted-foreground">New registrations will appear here.</p>
            </div>
        );
    }
                ...
                <table className="w-full text-sm">
                    <thead>
                        <tr className="border-b bg-muted/30">
                            <th className="text-left p-4 font-semibold text-muted-foreground">User Information</th>
                            <th className="text-left p-4 font-semibold text-muted-foreground">Account Status</th>
                            <th className="text-right p-4 font-semibold text-muted-foreground">Manage Actions</th>
                        </tr>
                    </thead>
